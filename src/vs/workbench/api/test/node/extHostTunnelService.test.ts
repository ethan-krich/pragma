...
const processes: { pid: number; cwd: string; cmd: string }[] = [
	...
	{
		pid: 2504,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Pragma Insiders',
	...
	{
		pid: 2526,
		cwd: '/home/alex/repos/Ethan Krich/vscode-extension-samples/helloworld-sample',
		cmd: '/bin/bash'
	}, {
		pid: 2719,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Pragma Insiders',
	...
	},
	{
		pid: 3071,
		cwd: '/home/alex/repos/Ethan Krich/vscode-extension-samples/helloworld-sample',
		cmd: 'node/home/alex/repos/Ethan Krich/vscode-extension-samples/helloworld-sample/node_modules/.bin/tsc-watch-p./'
	},
	{
		pid: 312,
		cwd: '/mnt/c/Users/alros/AppData/Local/Programs/Pragma Insiders',
