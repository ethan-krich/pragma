...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			metadata: {
				description: localize2('minWelcomeDescription', 'Opens a Walkthrough to help you get started in Pragma.')
			}
		});
	}
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			'type': 'string',
			'enum': ['none', 'welcomePage', 'readme', 'newUntitledFile', 'welcomePageInEmptyWorkbench', 'terminal', 'agentSessionsWelcomePage', 'projectCanvasPage'],
			'enumDescriptions': [
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.none' }, "Start without an editor."),
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "Open the Welcome page, with content to aid in getting started with Pragma and extensions."),
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.projectCanvasPage' }, "Open the Project Canvas when opening an empty workbench."),
			],
			'default': 'projectCanvasPage',
