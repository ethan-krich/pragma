...
description: Find duplicates for a Pragma GitHub issue
...
2. Follow those instructions PRECISELY to identify potential duplicate issues for a given issue number in the Pragma repository.
