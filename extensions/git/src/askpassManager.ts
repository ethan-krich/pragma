 ...
 * like GIT_ASKPASS point to scripts inside the Pragma installation directory, which
...
/**
 * Checks if the current Pragma installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Pragma updates.
 */
